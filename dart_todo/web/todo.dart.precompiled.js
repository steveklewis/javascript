...
["", "todo.dart", , N, {
  ...
  main: [function() {
    ...
    t1 = document.querySelector("#delete-all");
    $.deleteAll = t1;
  ...
  addToDoItem: [function(e) {
    var newToDo, t1;
    newToDo = document.createElement("li", null);
    newToDo.textContent = J.get$value$x($.toDoInput);
    t1 = J.get$onClick$x(newToDo);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.addToDoItem_closure(newToDo)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.set$value$x($.toDoInput, "");
    J.get$children$x($.toDoList).add$1(0, newToDo);
  }, "call$1", "addToDoItem$closure", 2, 0, 9],
  main_closure: {
    "^": "Closure:11;",
    call$1: function(e) {
      return J.get$children$x($.toDoList).clear$0(0);
    }
  },
  addToDoItem_closure: {
    "^": "Closure:11;newToDo_0",
    call$1: function(e) {
      return J.remove$0$ax(this.newToDo_0);
    }
  }
},
1],
