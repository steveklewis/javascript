...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__startNonWorker_closure: {
    "^": "Closure:66;box_0,functionName_1,isSpawnUri_2,startPaused_3,replyPort_4",
    call$0: [function() {
      var t1 = this.box_0;
...
["app_bootstrap", "index.html_bootstrap.dart", , E, {
  ...
  main: [function() {
    var t1, t2, t3;
    t1 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_counter, new E.main_closure(), C.Symbol_reset, new E.main_closure0(), C.Symbol_start, new E.main_closure1(), C.Symbol_stop, new E.main_closure2()], null, null);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_counter, new E.main_closure3()], null, null);
    t3 = P.LinkedHashMap_LinkedHashMap$_literal([C.Type_M6L, C.Type_GNh, C.Type_GNh, C.Type_I2I], null, null);
    t2 = O.StaticConfiguration$(false, P.LinkedHashMap_LinkedHashMap$_literal([C.Type_M6L, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_counter, C.Declaration_8aB], null, null)], null, null), t1, P.LinkedHashMap_LinkedHashMap$_literal([C.Symbol_counter, "counter", C.Symbol_reset, "reset", C.Symbol_start, "start", C.Symbol_stop, "stop"], null, null), t3, t2, null);
    ...
    $.initializers = [new E.main_closure4()];
    $.deployMode = true;
    A.initPolymer();
  ...
  main_closure3: {
    ...
    call$2: [function(o, v) {
      J.set$counter$x(o, v);
    }, "call$2", null, 4, 0, null, 55, 59, "call"],
    $isFunction: true
  },
  main_closure4: {
    "^": "Closure:66;",
    call$0: [function() {
      return A.Polymer_register("tute-stopwatch", C.Type_M6L);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  }
},
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 83, 19, 20],
  ...
  _rootHandleUncaughtError__closure: {
    "^": "Closure:66;error_2,stackTrace_3",
    call$0: function() {
      var t1, trace;
      t1 = this.error_2;
  ...
  _rootFork_closure: {
    ...
    }, "call$2", null, 4, 0, null, 70, 16, "call"],
    $isFunction: true
  },
...
["dart.collection", "dart:collection", , P, {
  ...
  Maps_mapToString_closure: {
    ...
    call$2: [function(k, v) {
      ...
      t1.write$1(": ");
      t1.write$1(v);
    }, "call$2", null, 4, 0, null, 85, 59, "call"],
    $isFunction: true
  },
  ListQueue: {
...
["dart.core", "dart:core", , P, {
  ...
  RuneIterator: {
    ...
    reset$1: [function(_, rawIndex) {
      ...
      if (t1.$lt(rawIndex, 0) || t1.$gt(rawIndex, J.get$length$asx(this.string)))
        throw H.wrapException(P.RangeError$range(rawIndex, 0, J.get$length$asx(this.string)));
      if (t1.$gt(rawIndex, 0)) {
        t2 = this.string;
        t3 = J.getInterceptor$asx(t2);
        t1 = t1.$lt(rawIndex, t3.get$length(t2)) && (t3.codeUnitAt$1(t2, t1.$sub(rawIndex, 1)) & 64512) === 55296 && (t3.codeUnitAt$1(t2, rawIndex) & 64512) === 56320;
      } else
        t1 = false;
      if (t1)
    ...
    }, "reset$0", "call$1", "call$0", "get$reset", 0, 2, 90, 91, 92],
    get$current: function() {
  ...
  Uri__normalize_normalizeHexDigit: {
    "^": "Closure:94;component_1,isNormalizedHexDigit_2,isLowerCaseHexDigit_3",
    call$1: function(index) {
      var t1, codeUnit;
      t1 = this.component_1;
...
["dart.js", "dart:js", , P, {
  ...
  JsObject__convertDataTree__convert: {
    "^": "Closure:46;_convertedObjects_0",
    call$1: [function(o) {
...
["observe.src.dirty_check", "package:observe/src/dirty_check.dart", , O, {
  ...
  dirtyCheckZoneSpec_wrapUnaryCallback: {
    "^": "Closure:101;enqueueDirtyCheck_6",
    call$4: [function($self, $parent, zone, f) {
      if (f == null)
        return f;
...
["observe.src.path_observer", "package:observe/src/path_observer.dart", , L, {
  ...
  _PathParser: {
    ...
    parse$1: function(path) {
      var codePoints, t1, mode, t2, c, type, typeMap, transition, actionName, newChar;
      codePoints = U.utf16CodeUnitsToCodepoints(J.get$codeUnits$s(path), 0, null, 65533);
      for (t1 = codePoints.length, mode = "beforePath"; true;) {
        t2 = ++this.index;
        if (t2 >= t1)
          c = null;
        else {
        ...
        if (0 >= t2)
          return H.ioore(transition, 0);
        mode = transition[0];
        actionName = t2 > 1 ? transition[1] : null;
        if (actionName === "push" && this.key != null)
          this.push$0();
        if (actionName === "append") {
          t2 = transition.length;
          if (t2 > 2 && true) {
            if (2 >= t2)
              return H.ioore(transition, 2);
            newChar = transition[2];
          } else
            newChar = H.Primitives_stringFromCharCodes([c]);
          t2 = this.key;
          this.key = t2 == null ? newChar : H.S(t2) + newChar;
        }
        if (mode === "afterPath")
          return this.keys;
      }
  ...
  _ObservedSet: {
    ...
    }, "call$2", "get$observe", 4, 0, 103, 104, 105],
    ...
    }, "call$1", "get$_path_observer$_callback", 2, 0, 15, 106],
...
["polymer", "package:polymer/polymer.dart", , A, {
    ...
    publishAttributes$1: function(superDecl) {
      ...
      if (attrs != null)
        for (t2 = C.JSString_methods.split$1(attrs, $.get$_ATTRIBUTES_REGEX()), t2 = H.setRuntimeTypeInfo(new H.ListIterator(t2, t2.length, 0, null), [H.getTypeArgumentByIndex(t2, 0)]), t3 = this.name; t2.moveNext$0();) {
          ...
          if (decl == null || decl.get$isMethod() || decl.get$isFinal()) {
            window;
  ...
  PolymerElement: {
    "^": "HtmlElement_Polymer_ChangeNotifier;change_notifier$ChangeNotifier$_change_notifier$_changes,change_notifier$ChangeNotifier$_change_notifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
  ...
  Polymer: {
    ...
    _propertyChangeWorkaround$1: [function(receiver, records) {
      ...
      for (t1 = J.get$iterator$ax(records), t2 = receiver.polymer$Polymer$_properties; t1.moveNext$0();) {
        ...
        if (t2.$index(0, $name) != null)
          continue;
        this._propertyChange$1(receiver, $name);
      }
    }, "call$1", "get$_propertyChangeWorkaround", 2, 0, 114, 106],
    _propertyChange$1: function(receiver, nameSymbol) {
      var $name, reflect;
    ...
    bindToAccessor$3$resolveBindingValue: function(receiver, $name, bindable, resolveBindingValue) {
      var getter, oldValue, property, t1, o, t2, subscription, setter, value, v, t3;
      getter = $.get$objectAccessor()._configuration.getters.$index(0, $name);
      if (getter == null)
        H.throwExpression(O.MissingCodeException$("getter \"" + H.S($name) + "\" in " + this.toString$0(receiver)));
      ...
      if (property == null) {
        ...
        t1 = this.get$changes(receiver);
        t2 = o.get$_propertyValueChanged();
        ...
        o._sub = subscription;
        t2 = J.open$1$x(bindable, o.get$_updateNode());
        o._lastValue = t2;
    ...
    createComputedProperties$0: function(receiver) {
      ...
      for (t1 = computed.get$keys(), t2 = t1._map, t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), [H.getTypeArgumentByIndex(t1, 0)]), t1._cell = t1._map._first, t2 = receiver.polymer$Polymer$_properties; t1.moveNext$0();) {
    ...
    bindProperty$3$oneTime: function(receiver, $name, bindableOrValue, oneTime) {
      ...
      if (t1.isLoggable$1(C.Level_FINE_500))
        t1.fine$1("bindProperty: [" + H.S(bindableOrValue) + "] to [" + H.S(this.get$_polymer$_name(receiver)) + "].[" + H.S($name) + "]");
      if (oneTime) {
        if (!!J.getInterceptor(bindableOrValue).$isBindable)
          t1.warning$1("bindProperty: expected non-bindable value on a one-time binding to [" + H.S(this.get$_polymer$_name(receiver)) + "].[" + H.S($name) + "], but found " + H.S(bindableOrValue) + ".");
  ...
  Polymer_notifyPropertyChanges_closure: {
    ...
    }, "call$2", null, 4, 0, null, 115, 50, "call"],
    $isFunction: true
  },
  ...
  PolymerJob: {
    ...
    }, "start$1", "call$2", "call$1", "get$start", 2, 2, 116, 18, 52, 117],
    stop$0: [function(_) {
      var t1, t2;
      t1 = this._id;
      if (t1 != null) {
  ...
  _hookJsPolymer_registerDart: {
    "^": "Closure:120;zone_0,originalRegister_1",
    ...
    }, "call$3", null, 6, 0, null, 118, 49, 119, "call"],
    $isFunction: true
  },
  _hookJsPolymer_registerDart_closure: {
    ...
    call$0: [function() {
      ...
      if (targetScheme !== "") {
        ...
        if (t1.get$host(t1) !== "") {
          ...
          if (t6 === "") {
            ...
            t6 = J.startsWith$1$s(t6, "/");
            t7 = t1._path;
            targetPath = t6 ? base._removeDotSegments$1(t7) : base._removeDotSegments$1(base._merge$2(base._path, t7));
            targetQuery = t1.query;
          }
      ...
      t5._rootUri = P.Uri$(t1.fragment, targetHost, targetPath, null, targetPort, targetQuery, null, targetScheme, targetUserInfo);
  ...
  _PropertyAccessor: {
    ...
    toString$0: function(_) {
      ...
      return "[" + new H.TypeImpl(H.getRuntimeTypeString(this), null).toString$0(0) + ": " + J.toString$0(this._polymer$_target) + "." + H.S($name) + ": " + H.S(this._polymer$_value) + " " + hasBinding + "]";
    }
  }
}],
...
["polymer_expressions", "package:polymer_expressions/polymer_expressions.dart", , T, {
  ...
  PolymerExpressions0: {
    ...
    static: {"^": "PolymerExpressions_DEFAULT_GLOBALS", PolymerExpressions$: function(globals, scopeFactory) {
      ...
      }, "call$1", "PolymerExpressions_getExpression$closure", 2, 0, 60], PolymerExpressions_getBinding: [function(expr, model, globals, oneTime) {
        var scope;
        if (globals == null) {
          globals = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
          globals.addAll$1(0, C.Map_wgEsG);
        }
      ...
      }, null, "call$4$globals$oneTime", "call$2", "call$3$oneTime", "call$3$globals", "PolymerExpressions_getBinding$closure", 4, 5, 61, 18, 62]}
  },
  PolymerExpressions_prepareBinding_closure: {
    "^": "Closure:121;this_1,identifier_2,bindExpr_3",
    call$3: [function(model, node, oneTime) {
      var t1, scope;
      t1 = this.this_1;
  ...
  PolymerExpressions_prepareBinding_closure1: {
    "^": "Closure:121;box_0,this_6,expr_7",
    call$3: [function(model, node, oneTime) {
  ...
  _Binding: {
    ...
    }, "_convertAndCheck$1", "call$2$skipChanges", "call$1", "get$_convertAndCheck", 2, 3, 122, 62, 51, 123],
    get$value: function(_) {
  ...
  _Binding_open_closure: {
    ...
    }, "call$2", null, 4, 0, null, 1, 124, "call"],
    $isFunction: true
  },
  ScopeFactory: {
    "^": "Object;"
...
["polymer_expressions.eval", "package:polymer_expressions/eval.dart", , K, {
  ...
  InvokeObserver__updateSelf_closure0: {
    "^": "Closure:127;this_0,scope_1,symbol_2",
    call$1: [function(changes) {
...
["template_binding", "package:template_binding/template_binding.dart", , M, {
  ...
  closure8: {
    ...
    }, "call$2", null, 4, 0, null, 106, 81, "call"],
    $isFunction: true
  },
  closure9: {
    "^": "Closure:66;",
  ...
  _TemplateIterator: {
    ...
    }, "call$1", "get$_updateIteratedValue", 2, 0, 15, 81],
    ...
    }, "call$1", "get$_closeInstanceBindings", 2, 0, 131],
  ...
  MustacheTokens: {
    ...
    _singleCombinator$1: [function(value) {
      ...
      if (t4 >= t3)
        return H.ioore(t1, t4);
      return t2 + H.S(t1[t4]);
    }, "call$1", "get$_singleCombinator", 2, 0, 132, 16],
    ...
    }, "call$1", "get$_listCombinator", 2, 0, 133, 134],
...
["", "tute_stopwatch.dart", , S, {
  "^": "",
  TuteStopwatch: {
    "^": "PolymerElement_ChangeNotifier;_tute_stopwatch$__$counter,mywatch,mytimer,stopButton,startButton,resetButton,change_notifier$ChangeNotifier$_change_notifier$_changes,change_notifier$ChangeNotifier$_change_notifier$_records,change_notifier$ChangeNotifier$_change_notifier$_changes,change_notifier$ChangeNotifier$_change_notifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$counter: function(receiver) {
      return receiver._tute_stopwatch$__$counter;
    },
    set$counter: function(receiver, value) {
      receiver._tute_stopwatch$__$counter = this.notifyPropertyChange$3(receiver, C.Symbol_counter, receiver._tute_stopwatch$__$counter, value);
    },
    attached$0: function(receiver) {
    ...
    detached$0: function(receiver) {
      ...
      receiver.mytimer.cancel$0();
    },
    start$3: [function(receiver, e, detail, target) {
      receiver.mywatch.start$0(0);
      receiver.mytimer = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 1), this.get$updateTime(receiver));
      J.set$disabled$x(receiver.startButton, true);
      J.set$disabled$x(receiver.stopButton, false);
      J.set$disabled$x(receiver.resetButton, true);
    }, "call$3", "get$start", 6, 0, 135, 1, 136, 137],
    stop$3: [function(receiver, e, detail, target) {
      receiver.mywatch.stop$0(0);
      receiver.mytimer.cancel$0();
      J.set$disabled$x(receiver.startButton, false);
      J.set$disabled$x(receiver.resetButton, false);
      J.set$disabled$x(receiver.stopButton, true);
    }, "call$3", "get$stop", 6, 0, 135, 1, 136, 137],
    reset$3: [function(receiver, e, detail, target) {
      receiver.mywatch.reset$0(0);
      receiver._tute_stopwatch$__$counter = this.notifyPropertyChange$3(receiver, C.Symbol_counter, receiver._tute_stopwatch$__$counter, "00:00");
      J.set$disabled$x(receiver.resetButton, true);
    }, "call$3", "get$reset", 6, 0, 135, 1, 136, 137],
    updateTime$1: [function(receiver, _) {
      var t1, s, m, minute, second;
      t1 = receiver.mywatch;
      s = C.JSNumber_methods._tdivFast$1(C.JSNumber_methods.$tdiv(t1.get$elapsedTicks() * 1000, t1.frequency), 1000);
      if (s >= 60) {
      ...
      t1 = minute + ":" + second;
      receiver._tute_stopwatch$__$counter = this.notifyPropertyChange$3(receiver, C.Symbol_counter, receiver._tute_stopwatch$__$counter, t1);
    }, "call$1", "get$updateTime", 2, 0, 138, 81],
    static: {TuteStopwatch$created: function(receiver) {
        var t1, t2, t3, t4;
        t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, W.ShadowRoot);
        t2 = P.String;
        t2 = H.setRuntimeTypeInfo(new V.ObservableMap(P.HashMap_HashMap(null, null, null, t2, null), null, null), [t2, null]);
        t3 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        t4 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        receiver._tute_stopwatch$__$counter = "00:00";
        receiver.mywatch = new P.Stopwatch(1000000, null, null);
        receiver.polymer$Polymer$_observers = [];
        receiver.polymer$Polymer$_readied = false;
        receiver.polymer$Polymer$_hasBeenAttached = false;
        receiver.polymer$Polymer$shadowRoots = t1;
        ...
        receiver.polymer$Polymer$_properties = t3;
        receiver.polymer$Polymer$_polyfillScopeStyleCache = t4;
        C.TuteStopwatch_methods.Element$created$0(receiver);
        C.TuteStopwatch_methods.PolymerElement$created$0(receiver);
        return receiver;
      }}
  },
...
G.ListChangeRecord.$isChangeRecord = true;
...
C.TuteStopwatch_methods = S.TuteStopwatch.prototype;
...
C.Symbol_counter = new H.Symbol0("counter");
...
C.Symbol_reset = new H.Symbol0("reset");
C.Symbol_start = new H.Symbol0("start");
C.Symbol_stop = new H.Symbol0("stop");
...
C.Type_M6L = H.createRuntimeType('TuteStopwatch');
...
Isolate.$lazy($, "_allTemplatesSelectors", "TemplateBindExtension__allTemplatesSelectors", "get$TemplateBindExtension__allTemplatesSelectors", function() {
  return C.JSString_methods.$add("template, ", J.map$1$ax(C.Map_05eTF.get$keys(), new M.closure6()).join$1(0, ", "));
});
