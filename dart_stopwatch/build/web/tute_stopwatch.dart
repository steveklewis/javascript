...
class TuteStopwatch extends PolymerElement with ChangeNotifier  {
  @reflectable @observable String get counter => __$counter; String __$counter='00:00'; @reflectable set counter(String value) { __$counter = notifyPropertyChange(#counter, __$counter, value); }
